...
<table width="100%" border="1" style="border-collapse: collapse">
    <tr>
        <td width="5%" bgcolor="black"><font face="MS Sans Serif" size="2" color="white"><b>รหัสสินค้า</b></font></td>
        ...
        <td width="30%" bgcolor="black"><font face="MS Sans Serif" size="2" color="white"><b>คงเหลือ</b></font></td>
    </tr>
...
<xsl:for-each select="products/product">
    <tr>
        ...
        <td><font face="MS Sans Serif" size="2"><xsl:value-of select="balance"/></font></td>
    </tr>
</xsl:for-each>
    </table>
</body>
